            ...
            <div className="faq-q-div">
              ...
              <div className={`faq-answer ${open[0] ? "active" : ""}`}>
                <p className="answer">
                  ...
                  four years we have grown to 15 locations with many more
                  planned to open soon. Our menu consists of globally inspired
                  street food such as tacos, burritos, bowls & poutines. We
                  pride ourselves in using only the freshest ingredients to
                  deliver excellence and provide our customers and community
                  members the experience they deserve! In 2021 the StrEATS brand
                  achieved $6,000,000 in revenue and a brand growth of 75% with
                  absolutely no signs of slowing down! We plan to continue to
                  grow the StrEATS brand internationally at the same blistering
                  pace we have done in the past, and we hope to expand globally
            ...
            <div className="faq-q-div">
              ...
              <div className={`faq-answer ${open[1] ? "active" : ""}`}>
                <p className="answer">
                  ...
                  to Web3. We at StrEATS understand the long lasting impact
                  crypto and NFTs will have on our world, and we believe that we
                  have something to offer the NFT space that has never been seen
                  before. By launching a project backed by real-world assets and
                  real-world utility, we also hope to help push the space
                  towards the public eye, and push the narrative that NFT’s
                  aren’t just pictures of monkeys you see online, but something
            ...
            <div className="faq-q-div">
              ...
              <div className={`faq-answer ${open[2] ? "active" : ""}`}>
                <p className="answer">
                  ...
                  join our Discord, where you will find a more in depth look in
                  to the future of Tenacious Tacos.
                </p>
              </div>
            </div>
            <div className="faq-q-div">
            ...
            <div className="faq-q-div">
              ...
              <div className={`faq-answer ${open[4] ? "active" : ""}`}>
                <p className="answer">
                  ...
                  receive a whitelist spot, however as the community grows we
                  will be running constant giveaways, contests, games and
                  tournaments for everybody to participate in. Make sure to keep
                  an eye on the Discord and turn on Twitter notifications for
                  @TenaciousTacos, @0xAliterit and @Nimberry#1109 in order to
                  have the best chance at receiving a spot!
                </p>
              </div>
            </div>
            {
